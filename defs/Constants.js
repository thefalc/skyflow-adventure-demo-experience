...
const WELCOME_MESSAGE = 'Welcome to the REBEL ALLIANCE.<br/><br/>' +
  ...
  '<div style="width: 80%; border: 1px dashed #fff; padding: 10px;">c - continue</div>';
...
const VIEW_AS_LUKE_PROMPT = 'Message transmission:<br/><br/>' +
  ...
  '<div><span style="color: red"><b>Note:</b> Luke sees the location of the Death Star based on the governance policy for his account. He sees partially redacted information for who sent the transmission, but it\'s enough to validate the transmission is authentic.</span></div><br/>' +
  '<div style="width: 80%; border: 1px dashed #fff; padding: 10px;">' +
  'c - continue<br/>' +
  's - share again<br/>' +
  'a - see analytics<br/>' +
...
const VIEW_AS_LEIA_PROMPT = 'Message transmission:<br/><br/>' +
  ...
  'Secure transmission from %s, Galactic ID: %n.<br/><br/>' +
  '<div><span style="color: red"><b>Note:</b> Princess Leia sees the location of the Death Star based on the governance policy for her account. She sees partially redacted information for who sent the transmission, but it\'s enough to validate the transmission is authentic.</span></div><br/>' +
  '<div style="width: 80%; border: 1px dashed #fff; padding: 10px;">' +
  'c - continue<br/>' +
  's - share again<br/>' +
  'a - see analytics<br/>' +
...
const VIEW_AS_DARTH_VADAR_PROMPT = 'Message transmission:<br/><br/>' +
  ...
  '<div><span style="color: red"><b>Note:</b> Even if Darth Vadar uses the force to intercept the transmission, he can only see tokens since he doesn\'t have permissions to detokenize the data.</span></div><br/>' +
  '<div style="width: 80%; border: 1px dashed #fff; padding: 10px;">' +
  'c - continue<br/>' +
  's - share again<br/>' +
  'a - see analytics<br/>' +
